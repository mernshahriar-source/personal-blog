---
title: 'Part 5: Console Input/Output'
date: '2026-01-11'
excerpt: 'Part 5: Console Input/Output'
categories:
...
তোমার program user এর সাথে কথা বলবে কীভাবে? 

Screen এ কিছু দেখাতে হবে, user থেকে কিছু জানতে হবে - এই দুইটাই এই part এ শিখবো।
...
`int.Parse()` টা string কে number এ convert করে দেয়। এটা নিয়ে পরে আরো detail এ বলবো।
...
কিছু জিনিস সরাসরি লেখা যায় না। যেমন, text এর মধ্যে নতুন line দিতে চাইলে কী করবে?
...
### Task 3
নাম, বয়স, শহর নিয়ে সুন্দর করে একটা bio print করো।
...
এই part টা অনেক গুরুত্বপূর্ণ। এগুলো না জানলে কোনো program ই বানাতে পারবে না। তাই ভালো করে practice করো!

**Next Part এ:** Variables আর Data Types নিয়ে কথা বলবো। কোন data কীভাবে রাখবে সেটা শিখবো।
